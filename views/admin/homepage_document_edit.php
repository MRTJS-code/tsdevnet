        ...
        <form method="post" class="form" enctype="multipart/form-data">
            ...
            <div class="actions">
                ...
                <?php if (!empty($entry['id'])): ?>
                    <button class="btn danger" type="submit" name="form_action" value="delete" onclick="return confirm('Are you sure you want to delete this document?');">Delete document</button>
                <?php endif; ?>
            </div>
        </form>
    </section>

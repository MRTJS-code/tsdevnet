                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline-form">
                                <a class="btn small ghost" href="/admin/homepage-technology-group-edit.php?id=<?= (int) $group['id'] ?>">Edit</a>
                                <form method="post" action="/admin/homepage-technology-group-edit.php?id=<?= (int) $group['id'] ?>" onsubmit="return confirm('Are you sure you want to delete this technology group and its entries?');">
            ...
            <table class="table">
                ...
                <?php foreach ($entries as $entry): ?>
                    <tr>
                        ...
                        <td>
                            <div class="inline-form">
                                <a class="btn small ghost" href="/admin/homepage-technology-entry-edit.php?id=<?= (int) $entry['id'] ?>">Edit</a>
                                <form method="post" action="/admin/homepage-technology-entry-edit.php?id=<?= (int) $entry['id'] ?>" onsubmit="return confirm('Are you sure you want to delete this technology entry?');">
                                    <input type="hidden" name="csrf_token" value="<?= Util::e(Security::csrfToken()) ?>">
                                    <input type="hidden" name="form_action" value="delete">
                                    <button class="btn small danger" type="submit">Delete</button>
                                </form>

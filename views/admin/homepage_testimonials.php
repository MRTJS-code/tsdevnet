                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline-form">
                                <a class="btn small ghost" href="/admin/homepage-testimonial-edit.php?id=<?= (int) $entry['id'] ?>">Edit</a>
                                <form method="post" action="/admin/homepage-testimonial-edit.php?id=<?= (int) $entry['id'] ?>" onsubmit="return confirm('Are you sure you want to delete this testimonial?');">
